...
"""
        ...
        self.assertIn('/conversation.js?v=20260818-running-session-signal', html)
...
"""
    ...
    def test_skill_actions_distinguish_edit_from_protected_delete(self):
        ...
        self.assertIn('/styles.css?v=20260818-running-session-signal', html)
        self.assertIn('/core.js?v=20260818-thread-ops-i18n', html)
    ...
    def test_language_picker_title_collapse_and_mascot_are_wired(self):
        ...
        self.assertIn('class="session-card-live"', conversation_js)
        self.assertIn("statusLabel(task.status)", conversation_js)
        styles = (static / "styles.css").read_text(encoding="utf-8")
        self.assertIn('[data-theme="wasteland"] .session-card.running', styles)
        self.assertIn('[data-theme="wasteland"] .session-card-live', styles)
